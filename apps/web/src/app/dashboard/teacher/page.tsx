  ...
  return (
    <div className="animate-fade-in space-y-8">
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 -mb-10 -ml-10 h-72 w-72 rounded-full bg-violet-500/10 blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <MagneticButton
              ...
              className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl px-5 py-3 text-sm shadow-md"
            >
              + Create Classroom
            </MagneticButton>
